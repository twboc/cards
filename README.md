<h1 align="center">React Native - Cards</h1>

<p align="center">
  Pokémon Cards renderer demo with hologram, gloss, background shaders, RGB split, inner and outer hologram masks, and different image outline styles including white, hologram, and masked holo GIF effects.
</p>

<table align="center">
  <tr>
    <td align="center" width="50%">
      <a href="https://www.youtube.com/watch?v=6W3GY5XjqZQ" target="_blank">
        <div style="position: relative; display: inline-block;">
          <img
            src="https://img.youtube.com/vi/6W3GY5XjqZQ/maxresdefault.jpg"
            alt="Full Video"
            width="100%"
      ...
      <br />
      <sub><b>▶ Full Video</b></sub>
    </td>
    <td align="center" width="50%">
      <a href="https://www.youtube.com/shorts/VbxFiI15JMs" target="_blank">
        <div style="position: relative; display: inline-block;">
          <img
            src="https://img.youtube.com/vi/VbxFiI15JMs/maxresdefault.jpg"
            alt="Reel"
            width="100%"
            style="max-width: 420px; border-radius: 14px;"
          />
...
Skia makes it possible to pass custom shaders, which are used here mainly for the background effects. I implemented several popular shaders inspired by ShaderToy, along with a few custom ones of my own. Shader rendering optimization was a major focus.

### Gesture

I used `react-native-sensors` to provide phone movement feedback. Gestures are also supported, so the cards can be moved interactively.
...
<a href="https://www.workdei.biz/pl/oferta/nadzor-procesu-budowlanego/" target="_blank">Nadzór budowlany</a>
</sub>
...
<a href="https://www.drl-clinic.pl/uslugi/cyfrowe-projektowanie-usmiechu" target="_blank">Metamorfoza uśmiechu</a>
</sub>
...
<a href="https://www.maxdent.pl/uslugi/implanty-zebow/" target="_blank">Implanty Wrocław</a>
</sub>
